...
INSERT INTO `order_to_optional_product` VALUES (202,8),(203,9),(204,8),(204,9);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 trigger UpdatePurchasesStatOptional_AFTER_INSERT
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 trigger UpdateAmountOptionalStat_AFTER_INSERT
    after insert on order_to_optional_product
    for each row
begin
...
-- Dump completed on 2022-01-17 18:29:45
