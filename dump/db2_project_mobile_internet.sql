...
CREATE TABLE `mobile_internet` (
  ...
  CONSTRAINT `fk_mobile_internet_1` FOREIGN KEY (`id`) REFERENCES `service` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `mobile_internet` VALUES (4,30,10),(5,45,15);
