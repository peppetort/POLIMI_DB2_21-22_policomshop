...
CREATE TABLE `stat_service_package` (
  ...
  `tot_monthly_fee` double NOT NULL DEFAULT 0,
  `amount_for_optional_prods` double NOT NULL DEFAULT 0,
...
INSERT INTO `stat_service_package` VALUES (25,24,2,35,70),(26,24,2,40,80);
